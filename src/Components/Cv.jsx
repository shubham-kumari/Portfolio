...
const PDF_FILE_URL = 'https://drive.google.com/file/d/1KhHs8kvSJ0-6LYHMjSqYwl5bG92fa5B7/view?usp=drive_link';
...
const Cv = () => {
    ...
    return (
        <>
            <div className='flex flex-col items-start justify-center lg:px-40 px-5 sm:pt-8 pt-8 pb-8 sm:h-screen text-900 font-mon font-medium sm:text-base text-sm border-b border-99 gap-1' id='resume'>
                ...
                <div className='flex flex-col items-start self-stretch'>
                    <div ref={experienceRef} className={`flex sm:flex-row flex-col items-start sm:gap-8 gap-5 self-stretch transition-transform duration-1000 ease-in-out ${experienceInView ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                        <div className='flex flex-col items-start sm:gap-1 flex-1'>
                            <p className='font-dm sm:text-4xl text-3xl'>Work Experience</p>
                            <div className='flex py-4 items-center self-stretch'>
                                <div className='flex px-2 pt-2 flex-col items-center self-stretch h-full'>
                                    ...
                                    <img className='sm:h-14 h-10' src={line2} alt="Line" />
                                ...
                                <div className='flex flex-col items-start self-stretch'>
                                        ...
                                        <p className='text-600 sm:text-sm text-xs'>Maxtron | Jan’25 - Present</p>
                                    </div>
                                    <div className='flex flex-col items-start self-stretch'>
                                    ...
                                    <div className='flex flex-col items-start self-stretch'>
                                        ...
                                        <p className='text-600 sm:text-sm text-xs'>Dep. of Holistic Education | Jan’24 - Apr’24</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='flex flex-col items-start sm:gap-1 flex-1'>
                            <p className='font-dm sm:text-4xl text-3xl'>Education</p>
                            <div className='flex py-4 items-center self-stretch'>
                                <div className='flex px-2 pt-2 flex-col items-center self-stretch h-full'>
                                    <img src={ellipse} alt="Circle" />
                                ...
                                <div className='flex flex-col items-start gap-4 flex-1'>
                                    <div className='flex flex-col items-start self-stretch'>
                                        <p className='font-bold'>B.Tech - ECE</p>
                        ...
                        <div ref={contactsRef} className={`flex flex-col items-start sm:gap-1 flex-1 transition-transform duration-1000 ease-in-out ${contactsInView ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                            <p className='font-dm sm:text-4xl text-3xl'>Contacts</p>
                    ...
                    <div ref={competencesRef} className={`flex py-2 items-start sm:gap-1 flex-col self-stretch transition-transform duration-1000 ease-in-out ${competencesInView ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                        <p className='font-dm sm:text-4xl text-3xl'>Skills</p>
                        <div className='flex sm:flex-row flex-col items-start sm:gap-8 self-stretch '>
                            <div className='flex py-4 items-start flex-1'>
                                ...
                                <div className='flex flex-col items-start gap-1 w-full'>
                                    <p className='flex flex-col items-start gap-1 self-stretch font-dm sm:text-2xl text-xl'>Methods</p>
                                    <div className='flex py-2 items-start w-full sm:gap-0 gap-8'>
                            ...
                            <div className='flex py-4 items-start flex-1'>
                                ...
                                <div className='flex flex-col items-start gap-1 w-full'>
                                    <p className='flex flex-col items-start gap-1 self-stretch font-dm sm:text-2xl text-xl'>Tools</p>
                                    <div className='flex py-2 items-start w-full sm:gap-0 gap-8'>
                                        <div className='flex flex-col items-start gap-2 flex-1 w-full sm:text-sm text-xs'>
                                            <p>Figma</p>
                                            <p>Sketch</p>
                            ...
                            <div className='flex py-4 items-start flex-1'>
                                ...
                                <div className='flex flex-col items-start gap-1 w-full'>
                                    <p className='flex flex-col items-start gap-1 self-stretch font-dm sm:text-2xl text-xl'>Technicals</p>
                                    <div className='flex py-2 items-start w-full sm:gap-0 gap-8'>
                                        <div className='flex flex-col items-start gap-2 flex-1 w-full sm:text-sm text-xs'>
                                            <p>HTML/CSS</p>
                                            <p>Java Script</p>
