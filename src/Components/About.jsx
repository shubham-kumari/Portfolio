...
const About = () => {
    ...
    return (
        <>
            <div className={`lg:px-24 px-5 py-16 text-900 font-mon font-medium sm:text-base text-sm flex lg:flex-row flex-col items-center justify-center sm:gap-16 gap-2 h-screen  border-b border-99 `}    id="about" >
