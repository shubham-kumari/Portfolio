...
const About = () => {
    ...
    return (
        <>
            <div    className={`lg:px-24 px-5 py-16 text-900 font-mon font-medium sm:text-base text-sm flex lg:flex-row flex-col items-center justify-center sm:gap-16 gap-2 lg:h-screen h-auto border-b border-99 `}    id="about" >
                ...
                <div className='flex flex-col items-start justify-center sm:gap-2 gap-0 sm:w-[450px] w-80 sm:px-0 px-3'>
                    <img src={star1} alt="Star 1" className='sm:w-16 h-auto w-8 transition-transform duration-1000 ease-in-out transform hover:scale-110' />
                    <div className='flex flex-col items-end justify-end sm:gap-2 gap-0 self-stretch sm:px-0 px-0'>
                        <div className='flex flex-col justify-center items-center gap-12 self-stretch'>
                            <img className='w-auto sm:h-[500px] h-80 rounded-2xl border-[12px] border-900 transition-transform duration-1000 ease-in-out transform hover:scale-105' src={profile} alt="Profile" />
                        </div>
                        <img src={star2} alt="Star 2" className='sm:w-16 w-8 h-auto transition-transform duration-1000 ease-in-out transform hover:scale-110' />
                    </div>
                </div>
            </div>
        </>
